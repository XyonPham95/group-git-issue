          ...
          <Card.Header className="d-flex justify-content-between">
            ...
            <div className="right">
              <DropdownButton
                ...
                title="Reactions"
              >
                <Dropdown.Item onClick={() => sendReaction("+1")}>
                  <img
                    style={{ height: "20px" }}
    ...
    <div className="container">
      ...
      >
        <div className="left">
          <h2>
            {singleIssue.title}{" "}
            <span style={{ color: "lightgrey" }}>#{singleIssue.number}</span>
          </h2>
        </div>
        <div className="right">
          <NewIssueButton
      ...
      <div className="bottom">
        <Card>
          <Card.Header className="d-flex justify-content-between">
            <div className="left">
              {singleIssue.user.login} commented at{" "}
          ...
          <Card.Body>
            <Card.Text>{singleIssue.body}</Card.Text>
          </Card.Body>
        </Card>
